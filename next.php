...
@keyframes leelaanimate{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-success text-uppercase animateuse" >  ONLINE EXAMINATION </h1>
    	<br><br><br><br>
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
            ...
            $checked_count = count($_POST['exam']);
            // print_r($_POST);
            ?>
            ...
            $finalresult = " insert into answers(aid, answer, ansid) values ('$name','5','$Resultans') ";
